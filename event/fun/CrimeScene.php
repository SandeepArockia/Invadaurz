...
<body style="font-size:1.4rem">
  ...
  <main>
        ...
        <div class="parallax-container hide-on-small-only">
          <div class="parallax">
            <img src="../../img/banner/CrimeScene.png"/>
          </div>
        </div>
        <div class="hide-on-med-and-up">
          <img src="../../img/banner/CrimeScene.png" class="responsive-img"/>
        </div>
    ...
    <div class="row <!--wow rollIn--> flow-text">
      <div class="section-white col l10 offset-l1 m10 offset-m1 s10 offset-s1">
        <div class="container">
          <div class="">
            <div class="center blue-text text-accent-2" style="padding: 0 0 10px 0"> CRIME SCENES </div>
                  ...
                  <div class="card-tabs">
                    ...
                    <div class="card-content">
                      <div id="test1" style="font-size:0.8em" class="active">
                        <ul>
                          <li> <span class="blue-text text-accent-2"> > </span> Prelims include a written test consisting of 30 questions based on logical and reasoning skills. </li>
                        </ul>
                      </div>
                      <div id="test2" class="" style="display: none;font-size:0.8em">
                        <ul>
                          <li> <span class="blue-text text-accent-2"> > </span> Each shortlisted team will be asked to solve a jigsaw mystery puzzle and crossword.</li>
                          <li> <span class="blue-text text-accent-2"> > </span> The teams will be provided with a video questionnaire on a projector to check out their observation skills. </li>
                        </ul>
                      </div>
                      <div id="test3" class="" style="display: none;font-size:0.8em">
                        <ul>
                          <li> <span class="blue-text text-accent-2"> > </span> Finalists will be taken to the crime sceneSolve the crime within the allotted time by taking the necessary snapshots, interrogating suspects and witnesses within an hour.. </li>
                          <li> <span class="blue-text text-accent-2"> > </span> Solve the crime within the allotted time by taking the necessary snapshots, interrogating suspects and witnesses within an hour. </li>
                        </ul>
                      </div>
                      </div>
