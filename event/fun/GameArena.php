...
<body style="font-size:1.4rem">
  ...
  <main>
        ...
        <div class="parallax-container hide-on-small-only">
          <div class="parallax">
            <img src="../../img/banner/GameArena.png"/>
          </div>
        </div>
        <div class="hide-on-med-and-up">
          <img src="../../img/banner/GameArena.png" class="responsive-img"/>
        </div>
    ...
    <div class="section-white col l10 offset-l1 m10 offset-m1 s10 offset-s1">
      <div class="container">
        <div class="">
          <div class="center blue-text text-accent-2" style="padding: 0 0 10px 0"> Game Arena </div>
